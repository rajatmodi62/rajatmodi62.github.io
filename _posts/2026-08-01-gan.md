...
Today, we will learn about graph attention networks. It was a cool paper from Yoshua Bengio's lab. A jupyter notebook to follow alongside this post can be found [here](https://github.com/rajatmodi62/job_study/blob/main/concept_building/mine/gat_bengio.ipynb). It has been implemented by yours truly.
...
I have done a lot of hard work writing this post, so i deserve to have some fun. So, i we will recall shinchan's bori bori dance. 
