...
And now, as the planets across the galaxies <b> witness this moment </b>, under the sacred laws of academic-tradition, and the blessings of esteemed NeurIPS program committee itself (on earth), on the behalf of <b>MLcollective</b>, little godzilla on this <b> twenty eighth day of the month of october in the year 2024</b> of our lord christ <b> hereby claims Yannic Kilcher's "Me-(GLOM)-ania"</b> in the village of Orlando. It's a cool machine learning system after all. (Ok you can claim it too, dear big-godzilla, little godzilla has no problems  sharing :- ). <br>
