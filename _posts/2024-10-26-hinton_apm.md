...
---
> APM is one of the first steps towards getting Geoffrey Hinton's GLOM working. The golden goose is how to encode part-whole hierarchies in a neural net. This work was accepted to NeurIPS2024. Three fucking years of blood and sweat. Paper can be found <a href="URL">here</a>. Chom Chom Chomsky. And all it took was a MLP.
...
<div class="caption" style="text-align: center;">
    <b>Geoff Hinton as a baby</b> holds an anaconda. conda activate <>, he cries. CONDA ACTIVATE <>, he yells. Godammn. But, conda keeps sleeping and hangs in the terminal. Conda is unable to breathe. Its environment has become too polluted. Arghhh.
</div>
...
You know, he really takes all this stuff seriously. A lot of people are excited for computer vision after all. As always he is such a cutie-pie and an amazing teacher. I have never been the smartest kid on the block. I'm not ivy league material. Far from that. I got put on academic probation, with a couple of C's in those computer vision courses lol.  
...
What's next after nobel and turing😂? Gotta catch them all. Maybe Mars should be next. Really, I'm serious this time. 
