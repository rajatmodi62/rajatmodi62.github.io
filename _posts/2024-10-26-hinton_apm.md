...
And now, as the planets across the galaxies witness this moment, under the sacred laws of academic-tradition, and the blessings of esteemed NeurIPS program committee itself (on earth), little godzilla on this twenty eighth day of the month of october in the year 2024 of our lord christ hereby claims Yannic Kilcher's "Me-(GLOM)-ania" in the village of Orlando. It's a cool machine learning system after all. (Ok you can claim it too, my lovely big godzilla, little godzilla has no problems  sharing :- ). <br>
