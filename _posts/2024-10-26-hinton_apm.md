...
And now, as the planets across the galaxies witness this moment, under the sacred laws of academic-tradition, and the blessings of NeurIPS program committee itself (on earth), little godzilla on the date Oct 28 in the village of Orlando hereby claims Yannic Kilcher's "Me-(GLOM)-ania". It's a cool machine learning system after all. (Ok you can claim it too, my lovely big godzilla, little godzilla has no problems  sharing :- ). <br>
