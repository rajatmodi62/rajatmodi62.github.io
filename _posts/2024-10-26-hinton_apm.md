...
<div class="caption" style="text-align: center;">
    <b> BEHOLD, O dear (H)-Uber/s who are also members of the borg/MLcollective </b>, gazeth at the six <b> INFINITY STONES</b> of <b>THANOS</b> in their full gl(h)ory: Nob(h)el, Tur(h)ing, Ros(h)en-blatt, Rumel-(h)art, (H)yun-dai, and Astur-(h)-ias. There are more stones too lol. But that will need other hand. That glove is still under manufacturing. We will update this blog later. Shorry. Ive limited time for this after all, have meeting with my advisor tmw. 
</div>
