...
Will they be your friends after they graduate and move cities/countries? 
...
dude, you should be grateful that you are in a position to mentor people.  please fix your self esteem. Spending a night in a homeless shelter will do wonders for you. Get out of your ivory tower, and live with less privileged for a day. Wear used clothes and volunteer in a pantry. you will know what hardship really means. Don't preach to people from your life of a house, expensive car, and a stable salary from an institution. 
...
Our dear investigator now wants to get a phd under someone. He wants to choose an advisor. So he does what seems obvious: go to google scholar, sort researchers by h indexes, and email the most popular one. This approach is a disaster. Find someone who is young, perhaps an assistant professor. He is trying to make a name for himself. Work with people who will lend their fire to you. An old professor will make you sleepy (with exception of a few good ones like Alexei Efros and Gil Strang ). Stay wary of people who just `demand results'. Instead ask them, 'i did so and so thing. It did not work. Here is what i am thinking next. What do you think?'. Judge them by the merit of their answer. For a year, 'do what they say'. If it does not work, it means their intuitions are wrong. You should jump ship as soon as possible. 

The subject of intuition is very treachorous one. Don't make the mistake of thinking what is 'popular today', is 'what is intuitive'. Here is how i have seen this story play out in my phd: Imagine a person comes up with an idea. He then runs experiments on it, and obtains a state of the art result. Then, he will try to invent all sort of crazy theories to explain why it is correct. For example, one blunder he shall make is `here is how biology works, here is how my idea works', and risk anthromorphizing the machine. 

One way to evaluate whether your theory is crazy is to check if anyone else arrived at it. For eg, for  my layer query network i knew that hinton had come up with recirculation. Turing also had a similar idea in his letter to the london's mathematical society. So, i don't pay heed to what other reviewer's say. 

But, for the theories i create of my own, i am deeply doubtful. Each attack on it exposes a loophole. Try to patch them up. If there are too many holes, then you have too many patches. At that point, learn to abandon your theory, and search for a more elegant one. 

The search for a grand unified theory has proved to be futile. Take care not to fall into that obsession. For eg, scientists succeeded in connecting electricity to magnetism, but gravity is still eluding them. Therefore, a general theory of neural nets might just not exist in our lifetimes. Take care that you dont spend a lot of time pursuing a dream of a foundational architecture. Even though it may sound plausible, it may turn out to be a very difficult task ,for it is nigh impossible to quantify what makes us intelligent. The best way we can work is invent all sort of crazy benchmarks, and test machines on them. But, we still don't have an idea of a perfect benchmark against which these machines ought to be measured. 



# <span style="font-size: 1.5rem; color: var(--border-header-bottom);">Trust issues </span>

Let us imagine that our young investigator goes to work under someone 'famous'. He is very happy at the opportunity. But, when he arrives at the laboratory,  he is deeply disappointed: he is given a boring task, which has nothing to do with what he actually wanted to do. He spends his energy trying to argue with his mentor. In this act, he loses peace of his mind, and energy which would have been better spent on the scientific pursuits. Gradually, The mentor begins to doubt the mentees ability to complete non-trivial tasks, does not trust him, and never teaches him the deepest darkest secrets of the art.  The relation gradually fractures, and the two drift apart. The mentor then starts hunting for other mentees. 

The issue here was not the lack of knowledge or intellect, but one of patience: 1) the mentor got famous due to a reason 2) the mentor is simply 'testing' the young man's resolve. There is a common misconception in the young investigator's head: his value is measured by his skillset. If he is most skilled, he will advance further than others. However, this is so not true. 

The thing that really matters is 'compliance': are you easily coachable or do you have an ego the size of a  balloon? Are you there to advance your agenda or your mentor's agenda? Technical skill can be taught, character cannot. Fame has a way of messing with your head. Take care to stay humble. Learn to deflect credit away. If you pile too much of it, you ego will grow. And ego has a way of killing careers. I have seen it play many times. The ones who started humble eventually ended up with puffed chests, to the point that noone wanted to work with them anymore. 

Don't grow secure if your mentor starts trusting you. Don't assume a `personal relationship' with your mentors. They respect your work and science. Here is how this plays out: a phd student publishes xx works. He becomes proud. He starts mentoring others, and starts cutting/publically disagreeing with his mentors mid speech. The mentor gradually becomes alienated. He stops supporting the student. The student  fades into the oblivion. Take care not to shit in the plate from which you are eating. Always respect the hierarchy. It exists for a reason. If you have disagreements, resolve them privately. Give away credit publically. 

I have seen students `sell their soul' for money. For example, xx company offers xx amount. Come work with us and do yy. We will relocate you, pay air travel, and free gym/medical insurance etc.  The investigator runs after the money, and forgets his efforts doing zz. Always remember why you started zz. See it through to the end, even if it takes a lifetime. It is not your work that matters. It is the lineage of zz work you ought to be protecting. Always remember that. You will notice this pattern in the berkeley professors: they often publicize their 'academic trees'. This is because they feel proud of the ideas of their predecessors they are helping carry forward. Not many people understand that, and just jump off to the next cool method in the town. Note that this does not mean that you don't join xx company. The collaboration between industry and academia is immensely important. Without efforts of the industry, LLMs wont exist. We would not have seen so much progress in our lifetimes. 

But, as an investigator, you must maintain a sense of the bigger picture: here is where industry is going. here is where it may go next. Here are the technical challenges. I believe they will be solved in yy amount. For that, we need zz steps. Often the steps will boil down to technical challenges, and not money: there is enough of it around, and big companies can afford risks in millions. If you cannot predict yy and zz reliably for a short term in future (say 5 years), you are not doing a good job. Always hold yourself to that standard. Write down what you predict today. Compare it one year later with current state of the field. 
...
I beg of you, don't let it get to your head. Remember who made you what you are. Remember their sacrifices. Remember their belief when you were a `no one'. Unfortunately, most people treat their phd's as a transaction: you do xx papers, and then you graduate. You leave your mentors, and never talk to them again. It DOES NOT work like that. Make sure your mentors become your collaborators, and not people you lose with your success. Otherwise, like Steve Jobs you will lay at your death bed and find it hollow. One really good ego killer is to remember the passing of your loved ones. Whenever you find your ego getting better of you, remember the pain of their passing. Remember your time on this earth is temporary. 


# <span style="font-size: 1.5rem; color: var(--border-header-bottom);">Everything you were taught may be wrong</span>
...
Never make the mistake of thinking application is 'inferior' to theory. Einstein had to wait for someone to go around the globe and observe a solar eclipse to prove his theory of relativity. Hopfield got his nobel at 91, even though he wrote about associative memories back in the 1950's. Cajal `perfected' golgi's staining technique, yet shared the same honors as the original inventor. Curie applied the Becquerel principle of radioactivity, and shared the honor with him. Theory is nothing without application. It is application and the power of observations that separates whims of the theorist from the actual existence of the physical law. Mathematics of learning machines still has not gotten to the point where it can predict the sort of emergent behaviours which a group of neurons gain together as a consequence of wiring them together. 



# <span style="font-size: 1.5rem; color: var(--border-header-bottom);">Choose the kind of paper thy shall write</span>


Young investigator should choose the kind of paper he wants to write. Specifically, this boils down to two categories:

1) Benchmark chasing: Take a method. Improve it by changing one component. Get better results. Publish. 
2) Poke the giant: Take a fundamental assumption everyone is making in the field. Poke holes in it. Show that you can do better. 

Most of us (including me) are content with the first kind of paper. It guarantees an easy win, a successful acceptance. The academic machinery becomes very happy at being `fed continously'. 

The second kind of work is met with friction. Reviewers get hostile. They throw insults in the rebuttal. For eg, `i am sure you have never read a paper on TTT, and have grossly misunderstood the basic ideas'. As authors, you have to still respect the 'politeness'. If you don't, you reduce yourself to the same level as a petty reviewer, and that is just not worth it. Even if it gives you the win, there is no deep satisfaction. 

Most people spend their lives in the framework, the laws which they believe to be correct. When they sense the `wall of fundamentals crumbling', their first reaction is defence. For example, they will say:  'you are stupid', 'you must have made a mistake', 'nobody will ever accept it'. It takes a rare kind of courage, and honor to keep going on for years inspite of all the noise. You must learn to tune out the noise, and drive your brain at a resonant frequency. You must embrace loneliness which comes by being someone who has to navigate a frontier alone. You must be willing to accept the fact, that your work will never be understood in your lifetime. Letting go of the desire for status and prestige, and merely pursuing the science for it's own sake, is a capability which is very difficult to master: occasional reward drives action, and without any reward the motivation must be internal. That is the reason most machines of today cannot do things that a driven man can do: they have no notion of selfness, or sacrifice. 
...
Don't make the mistake of naming your papers  something silly. For eg, `Godzillanet, or little dino'. There is a deep academic tradition of naming papers like 'On computable numbers etc...', ' A Treatise of...'. I made the mistake of sticking a dino in my APM paper, and that is one of the deep regrets i still have. Respect the tradition. Respect the system. It shall respect you back in time. Don't claim public glory. Practice Slow Science. The slower you move, the better it is. Take 2 years to publish your papers. Sit on them. Let them grow deep. Everyone likes a butterfly which took time to grow. A premature baby is born unhealthy, and risks passing away from this world before its destined time to go has arrived . Don't make that mistake. 

Learn to kill your darlings PREMATURELY. Most people latch onto their ideas emotionally (including me). They will go the grave trying to defend it. Even if a reviewer points something serious, they will choose to defend it. They think that they can fool a reviewer into forcing their point of views. Don't make that mistake. Only do rebuttal if it makes sense.  Let me give you an example. One of my papers (layer query networks) has now gotten rejected five times in a row, with two desk rejects. By all measures, it is dead. There is no point in submitting it again. A better idea is to just submit it to some lower tier venue and move on. 

It is good to have ambition to publish in top places of the world. If it does not work, learn to calmly evaluate what went wrong. Don't make the mistake of fixing it in `that particular paper'. Let me take another example. In ECCV 2024, i messed up the experiments. The idea was good, but there was just too much baggage: the experiments were too complex. The whole thing was a just giant mess, and a soup of experiments. So, i withdrew it, reran all baselines and finally made it to NeurIPS. 

It is disasterous if all you care about it `publishing' and not the quality of your work. A lot of people publish. Learn to care about your work. Only then, can you sustain the sacrifice over long term that science demands. 
...
The next step is to 'take ideas from your area' and apply it to something popular. For eg, i took GLOM's ideas and applied it to test time training on long videos: a very hot problem right now. Don't FOCUS on Specializing in an area. Say you want to become a professor. You will have a lot of students working on a lot of problems. If your own thesis was too narrow , you will have a hard time advising: because you have a narrow outlook, and cannot `abstract away'. You might have to spend a lot of time doing postdoctoral studies just to develop the skill to work with multiple people at a time. 
...
You must learn to separate "implementation" from the "mechanism". For eg, positional encodings inject ordering information. Therefore, any way to inject order in the neural net can be used in future. Now, if someone comes and says "order is not necessary, let the network figure it out", you must know that it is philosophically incorrect. All your assumptions should be anchored in philosophy: which is VERY HARD to be proven wrong. But, you must know the counter-philosophy. Let me take another example. 


A lot of biologists think darwin's theory of evolution is correct. They have built entire field of evolutionary learning and principle of natural selection around the core premise. You must know of the other camp: thoughts of Fodor, and what are the loopholes in darwin. If someone comes along and proves darwin wrong, most of the people in evolutionary computing will panic. Since our young investigator thought of the loophole far before, he shall be safe. While the world undergoes turmoil, he might sit silently among the waves emanating in the field, and develop the ability to observe the ripples as a calm detached observer. The ripples shall wash over him, but he shall remain forever etched in stone for his thoughts were firmly anchored to the earth, and not merely floating in the sky without tether. 

Those who fly egoistically have a way of falling down on their faces. Let me take my example. I flew too high in NeurIPS 2024, and life taught me a harsh lesson. Those who remain grounded however retain their tactical position long after the storms have withered away. You must learn to master this art, for this is the only thing that can prevent you from `getting scooped away' by someone who managed to publish before you, and reduced your effort to ashes. 


If you had hedged your philosophical bets correctly, you can rise from the ashes like a phoenix and claim "deeper understanding": Why the SCOOPER's method works? You go ahead and provide a theory. In long run, a theory is more general than the SCOOPER's mere application of it. If you have thought hard enough, you will have more depth. 
...
The only skill that matters here is perseverance: the ability to keep going even when odds are stacked against you. Not many people have that. One cool trick to train this muscle is to do strength training: push your body to lift more weights than it can. Keep pushing it before it breaks. If your mind can conquer the feebleness of your body, then perhaps your mind can conquer the superficial nature of the reviewer 2. 
...
99% of us are not creative enough to do this work on our first day. But instead of being angry, learn of it as a  mission to always strive towards. Always question : what is one key abstract insight i am pushing in my own work? It is important to take a note here. I made mistakes in my papers where i stacked `multiple incremental shit' together, for eg, a benchmark, a new method, a new evaluation metric. The reviewer ended up confused on my contributions. It was an accept, but the average ratings were borderline. 

A good paper has only ONE single idea. All the other technical contributions REVOLVE around THAT IDEA. But, it has many experiments trying to `BREAK the method' in the most 'BRUTAL' of standards. Become your biggest critique. If you can satisfy yourself, only then the reviewer 2 shall be appeased. I would also like to note how ilya wrote his papers earlier on: 'our key contribution is xx. our key experimental result is yy'. Two lines, and whole story becomes clear. Learn the art of writing. 


If you will stay at the superficial level of measuring the quality of your research by ONLY performance on benchmarks, you are doomed to fail. You must extract the deeper reason of representation. Both benchmark and representation are important. Let me take an example. Most people just inject tokens of their domain in a transformer, get state of the art results , and call it a day. You must understand what makes the transformer click? Why does it perform a perform of general differential computation that it does? 

Learn from the success of the transformer and apply it to your own architecture. 

# <span style="font-size: 1.5rem; color: var(--border-header-bottom);">The illusion of  compute and memory</span>

Let me now turn to an advice (by Alex Alemi) that shattered my own illusions. I hope that he is ok with me writing this lol :-).
...
Your job is to demonstrate a solution which works better than the state of the art at small scales (like one ampere gpu of 48 gigs). Then you scale it up to 80gigs, or at most 4 ampere gpus. The problem then is to demonstrate the scaling curve. That your `rate of increase' is faster than the baseline method, and it stands to reason that you will outperform the baseline. Please note that the amount of time you must train for to make appreciable performance difference really matters. If you have to run the computing machine for 100 years to get the measurable performance different w.r.t baseline, your entire effort is futile. It is better to chase another worthy problem to work upon. This problem was in the energy based transformer paper, which raised a lot of criticism in the review process. Eventually they made it in two tries, and i am very happy for their success. 



# <span style="font-size: 1.5rem; color: var(--border-header-bottom);">One man's taboo is another man's science</span>

There are certain problems which lie in the realms of the mystics. It is often considered a `taboo' to  touch them. Therefore, such people often prefer to stay in the shadows, and publish by stripping away these 'sensitive' terms. 

For eg, how does one define consciousness? This `does not' have a precise experiment the young investigator could perform in a machine. A turing machine merely mimics the outputs of a human. Just because it quacks like a duck, looks like a duck does not mean 'it is a duck'.  
...
There appears to be one curious tactic of flag planting: researchers put out half-baked ideas, and non peer reviewed manuscripts on arxiv, so as to claim `their territory'. It appears community 'wants' to play this game, hence the lifting of the arxiv ban from the recent tpami meeting. While this has a merit of protecting one's ideas, it is a great source of depression to our young investigator. 


Here is the key issue: when you begin, you dont have a significant body of work. You spend a year, and all you have is a single paper you produced. You don't have collaborators yet. Therefore, the stakes are too high. If you put your paper on arxiv, someone will just scoop it up , and you will be left with nothing. That is a real fear which keeps many people up at night.  Unfortunately there is no way to avoid it. There is a prestige tax one ought to pay. This is part of that. But, trust me, after 3 -4 papers in, your life starts to change in ways which feel a little bit more natural. Perhaps you gain a worldview: how this world operates, and know where to apply the exact work, and how much of it.  


One way to get around arxiv tactic is: maintain a blog. Don't publish on arxiv. Write your thoughts down. People have a curious way of thinking that you only need to write `useful things' . But these things do not appear until you lay bare in a clear manner all the thoughts of your mind, until you can take the next logical course of action. Learn how to write. Join a writing club if you can. Write Novels. Read Isaac Asimov, Arthur C Clarke, and other science fiction writers. Produce a lot of shit. A lot of incremental shit. Perhaps you will end up with one good idea.  Don't make the mistake of thinking that incremental work (benchmark chasing) is NOT IMPORTANT. It is what tells you limits of the current paradigm. Only then can you afford to change it. 


# <span style="font-size: 1.5rem; color: var(--border-header-bottom);">Have COURAGE to pursue two research identities</span>

There is another piece of advice. There is one research you conduct for your doctoral work: the stakes are high, and you cannot afford to fail. You must have a second track: where you  work on something fundamental. The way to test for this is simple: ask if you know the answer? It should be NO. Ask if other people think it is possible? It should be NO. Ask if you 'think' it should work. It should be YES. 
...
The young investigator must now understand the reviewer psychology prevalent in these conferences. Please let me explain. 


I tend to categorize reviewers into three categories. 

1) The benchmark chasers: They reviewers will expect your paper to be `rigorous'.  For them, rigor means the breadth of experiments. For eg, at least 10-12 datasets, 3-4 tasks, extensive ablations by removing each component of your method, and introducing just one component at a time. If there are n components, they will expect to see 2^N ablations. You will find these kind of reviewers inhabit cvpr, iccv, eccv because they are concerned with practical applications: how well does your work 'translate to TODAY'. If it does not work TODAY, but merely 'shows potential' they will reject your paper. There is no other way to argue/convince them. They will hold you accountable for a 'missing baseline', 'compute efficiency', 'oood generalization' and whatever rejection they can dream up. This reviewer will send your paper to the graveyard, and their is no point of arguing with him. Leave him be. 

2) The fundamentalist: This reviewer latches onto `your idea'. He doesn't care much about benchmarks as long as your method is 1-2 percent lower than the baseline, but the idea reveals something subtle. There are high chances to find this kind of reviewer in NeurIPS. 

Most people's paper's (including mine) lie in category 1), but they `like to think out of their egos'  that their papers lie in the fundamentalist category. KNOW THY PAPER!!. And that is the reason, most people end up getting rejected at NeurIPS, for their ideas are 'not abstract enough'. This is not a good/bad thing: it just is the nature of conference. The sooner our young investigator accepts this reality, the better his life may get. 

Now let me tell you about the two classes of `our fundamentalist'. 

2.1) The narrow visionist: He is typically an 'expert' in the subject matter your paper is about. For eg, if i wrote test-time-training paper, then the one who works in TTT might lie in this category. They can understand the impact of `fundamental ideas' in 'only' their area. If you bring in insights from other areas (say biology), he will say that: 'it is not rigorous/formal enough'. Be careful NOT TO ALIENATE this reviewer. Since he is the expert, he is the voice of the reason in the room. He still expects many results on the prevalent benchmarks in his area of interest (for eg, in TTT, benchmarks are ImageNet, ImageNet-C, etc). If you don't have results, he will still reject your paper. 

2.2) The broader thinker: This class of reviewer is very very very very rare. He does not need any benchmark to know the validity of your ideas. He is so expert that he can just look at the results on a single dataset (say MNIST/CIFAR), and tell whether your method is garbage. For them, physics matters. Some good example of such people are Max Welling, Geoffrey Hinton. For such people , research is not about incremental work, but `hunting' for solutions most people don't even know how to frame. If you even are able to frame the 'question' properly, he will trust you with the inner circle. 

Let me take an example. What is the connection between turing's morphogenesis, the theory of light, and the neural net?

To a normal person there is none. Most will think it is separate. Most will call it a `desperate' attempt to bridge fields together. 

To the broader thinker, morphogenesis is a way to study pattern formation in biological organisms. Each organism starts from a single cell, replicates, and gives full organism. Similarly, light starts from a single point and expands outwards in a wave front. A neural net (like hinton's glom) does something similar. This is very deep connection, and run of the mill fundamentalist won't even understand it. There are almost 100% odds, this thinker won't ever be on review panel, because these tend to be senior professors: at that point of their lives, they are retired and hold `emeritus' status, or serve as AC/SAC. However, if i read the room correctly, they won't ever serve on program committee: the simple reason being that administrative tasks 'suck the soul' out of their creativity. They would rather prefer to be left alone. Their state of brain is not of ego or clout chasing but of the fundamental truth. They might find more joy in failures rather than success for the former opens up more pathways to explore. In other words, they are  fully grown dragons who have grown weary of life and are content to sleep and dream about what the world ought to be. Occasionally they might open their eyes, and nudge the other young dragon chicklets on where they ought to go.  

Any society ought to have and deeply respect these thinkers. The sum of their knowledge is  vast and their role is `that of an archivist'. They remember history of the field, and can see whether we are merely spiraling back into old ideas or are genuinely discovering new ones. Let me give another example, while i was working on GLOM, i genuinely thought that my contributions in TTT were novel. Later, it turned out Vladimir Vapnik had already discovered the fact around 50 years ago in his paper on the statistical learning theory. Had i known of the fact before, it would have taken care of my ego, which grew out of bounds during that period. I had to spend six months on a mountain in India after taking leave of my phd, just to calm myself, and get back into a working zone, instead of chasing the glory. Don't make that mistake. Otherwise, time shall force you to 'take a break'.




# <span style="font-size: 1.5rem; color: var(--border-header-bottom);">Read the Rebuttal Room</span>

Reviews are out. And you have decided to do a rebuttal!!. Let us imagine your splits are extreme (2,5,6) on a scale of 6. By all `logic' your paper is dead: unless all people vote accept, you are rejected. Trust me this is so not true. We  have managed to move needles on papers with (7/5/3/3 on a scale at 10 at NeurIPS-> 7 7 6 5 post rebuttal), (6 5 2 -> 6 5 3 at ECCV (and accept inspite of one reject), 7 5 3 3 -> 7 6 5 3 (accept), (5 4 1 -> 5 4 4) at cvpr). Some fights we lost, but some we won. The illusion of a 'unanimous accept' is wrong. The 'illusion that reviewer scores/confidence matter' is also wrong. 

What matters is the actual substance of the technical criticism they write. Defend that. Dont ask them to increase their scores. The moment you do that, you shift from a `peer' to a 'student'. It is very easy to spot the change of tone, and hint of desperation in the rebuttals. That does not yield any positive outlook for your case. If you have complaints, write it to AC. That mechanism exists for a reason. Let me give you stats. Out of 5 papers i have submitted multiple times, i had to write a message to AC every SINGLE time except ONE. That just is the nature of randomness of the peer review: sometimes life doles out a random draw, and you just have to learn to live with it. 

Now, let us look at reading the rebuttal room with a set of scores (2,5,6) on a scale of 6. Most people will spend time convincing 2 to raise their scores. That strategy wont work. If you build your rebuttal around 2, the people who  `champion' your paper (5/6) will see it as a sign of 'weakness and lack of confidence in your own idea' and 'lower' their own scores. I have seen many people make this mistake many times, and end up with far 'worse' scores that what they got pre-rebuttal. I have one such case: the guy who tanked the paper, forced all the reviewers to drop their own. We had three borderlines accepts, one reject. It happened to me in ICLR 2026. We had a clear majority but still lost it.  The reason was that 'there was no champion'. Borderline is safe to give, but no reviewer was willing to stick their neck out for the idea.  Now that i think of it, it is simply because i wrote an 'incremental paper'. That is why my scores were borderlines. 

Here is how an alternate defence strategy might look: evaluate if the reviewer who gave reject (the score 2) has any technical merit? Are those fixable? If so fix them. Next, is the curious trick: Build your defense around the 6. He is your 'champion' in the room. He will go to the ends of the earth to defend your work. Use his expertise. Give him all the ammo he needs to help oveerride the 2. Scores of 5/6 are two reviewers in your favour. As long as you have majority (and one champion), you have a chance to appeal your case. But your rebuttal `must hurt some egoes'. Only then will your paper go above AC level, and land on the desks of SAC, PC. Only then will a separate committee sit together and look at your case carefully. If you write a 'run of the mill rebuttal', AC will note 'the lack of consensus', stamp a reject and move on. At the level of decision making, nobody cares how much effort you put in .There are 30K papers to evaluate, and it is only the technical merit that counts. So you must be willing to 'bruise some egos' if you want the satisfaction of an  acceptance in the end. 

We must now think of this from the perspective of the scientific institution: 'decisions are risky'. The institution wants to 'minimize the risks'. So it will first accept all the 'obvious accepts', and then 'reject' all the low ones. For borderlines, 'they will try to build a consensus among the reviewers'. If reviewers reach a consensus, AC's job is easier: they will go with consensus. If there is 'no consensus', AC checks the 'spiciness level of the rebuttal': if emotions are running high, he will escalate. There is a team of three AC's (who vote), SAC stamps approval, and moves on. It never escalates to PC except in the rarest of cases. Classically, only the cases of 'ethics violations' perhaps reaches them. 

Most people dream of ideal scores (6/6/6 on a scale of 6). Unfortunately that barely happens. Most papers will get an average borderline scores of (3.5). It is really tough to decide on those papers. That is the reason most people feel that peer review is a `game of lottery'. Your job is to stir up the hornet's nest. You must learn to either land in the reject pile (Average score of 1-2), or accept pile (5-6). Most people think that accept pile is good (5-6). Papers in reject pile (1-2) are assumed to be dead. So let me now focus from how to move a paper from a 'dead' pile to an 'alive' pile. 

We must first put ourselves in the shoes of an AC. Let us first try to crunch some numbers lol. Let us consider the case of ICML 2026. There were 1700 AC's, around 23,918 submissions entered review (after desk rejections. ). This means each AC handled 14 papers (assuming no overlap with other AC). 25% acceptance means around 3 papers were accepted by each. 11 have to be rejected. Even if one AC chooses more to accept , overall 25% has to be maintained to maintain the prestige of the system. It means 3 papers are chosen out of 14, so 3 `safest' ones with unanimously positive across the board have 'some chance' to be accepted. 

Now, let's assume you are in 1-2 reject spot. From a strategic standpoint: AC won't stick his neck out for you, since he will go with 3 safe papers. Your only true competition are the borderline cases. If you will take one spot of a borderline which would otherwise have been accepted, that means that the borderline would have to be rejected. Therefore, you `must make sure', that your rebuttal gets 'escalated'. You must let the hot heads fight, and become the voice of the reason. The moment you let go, or reveal a slight shiver of anxiety, you shall lose the battle of peer review (sorry for the drama lol). 

Now i must comment on how to retain your sanity in these stressful times. Olympics/ Marathons are short, for their outcome gets revealed in a week. Peer review, takes months and often years. I found NeurIPS/ICML/ICLR to be most friendly: within two weeks of rebuttal/feedback window you at least can predict the outcome of your paper. You can also talk to reviewer. A lot of people don't like this: beause they dont like writing pages of rebuttal and are always driven by the `fear' that they shall be 'caught'. For those who like to build new mechanisms, this is a sweet opportunity: you get to debate the people. Learn of your strengths and weaknesses. If you get uncomfortable with your reviews becoming public, prefer the solace of the shadows. Submit to CVPR/ECCV. 


In case of CVPR/ECCV: rebuttal is not so much friendly. You are forced to write a one page rebuttal, and the reviewer feedback comes too late (one month). You are a sitting duck in that period. Learn to let go. Musing on what you cannot control is a fool's errand. Work on other projects. Help an occasional labmate out. Go sit in the sun. Do anything it takes to protect your peace. 

The young investigator must also be wary of the `negative psychology' when he is coauthoring a paper in which he is not the first author. I have heard many people say: 'it is first author's paper, so it won't count for me.' That is why they are not happy at the other people's achievements. Learn to be generous. Share achievements of others. Supress your own. Uplift others. Let others uplift you. That is the only way by which you can break out of this cycle of 'transactional papers'. In both cases, the outcome is papers. It is the mental shift that really breaks the barriers. If you keep yourself at the transactional level, people will use you, and thy shall be forgotten. That is the nature of life. 

# <span style="font-size: 1.5rem; color: var(--border-header-bottom);">Read books and not papers</span>
There shall come a time in a young investigator's life when he might grow a certain amount of intuition. Papers no longer offer new information. You learn to see right through the bullshit. Everyone stacking the same transformer blocks, using low data setup, optimizing compute,  preaching novelty, and `beating' the state of the art. Never use the term  'beat'. It means you are competing. Say, we 'demonstrate' competitive results if you surpass them. Undersell your words. Let the results do the talking. 

At this juncture of your career, it may be better to read books. Pick up sutton's RL, read it end to end like a novel. If you have really grown, you can read it without a significant mental effort. If you can't , well, you still have a lot of work to do. Read across fields, for eg, cognitive science, biology, molecular machines, psychology of mind. DONT read stuff you actually work on, since the mind then does not wander off. Only when you let it be distracted by the thoughts of other fields, can you pull something from one field and apply it to another. Over time you will find that this becomes a natural phenomenon. The young investigator is deeply cautioned here: it might take decades to pan out. 
