...
<!-- 
One teeny tiny benchmark by which i try to measure my progress: 1) something which can run in a toaster for less than twenty dollars 2) something which is as powerful as a big model without loss in performance. 3) something which can train on-device on the chip and does not need a big cluster. 4) something that possesses maternal and moral instincts to care for beings lesser intelligent than it. Obviously, it sounds weird and stupid. That's the fun of it. Only time can tell. -->
<!-- 
