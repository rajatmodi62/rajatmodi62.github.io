...
The challenge then is which one to solve first. Now that i hold these problems in mind, i keep looking for cool tools which will enable solving them. And as soon as something appears, i drop all i am doing, and get back to solving it. From a recruiter's perspective, my work is "high risk-high variance". 
